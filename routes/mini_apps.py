...
@mini_apps_bp.route('/suggest_supplement', methods=['POST'])
...
@mini_apps_bp.route('/check_food_interaction', methods=['POST'])
...
@mini_apps_bp.route('/recipe_variation', methods=['POST'])
...
@mini_apps_bp.route('/flavor_pairing', methods=['POST'])
def flavor_pairing():
    data = request.json
...
@mini_apps_bp.route('/quick_snack', methods=['POST'])
def quick_snack():
    data = request.json
...
@mini_apps_bp.route('/hydration_tip', methods=['POST'])
def hydration_tip():
    data = request.json
...
@mini_apps_bp.route('/mood_food', methods=['POST'])
def mood_food():
    data = request.json
...
@mini_apps_bp.route('/energy_booster', methods=['POST'])
def energy_booster():
    data = request.json
...
@mini_apps_bp.route('/recovery_meal', methods=['POST'])
def recovery_meal():
    data = request.json
...
@mini_apps_bp.route('/sleep_aid', methods=['POST'])
def sleep_aid():
    data = request.json
...
@mini_apps_bp.route('/digestive_aid', methods=['POST'])
def digestive_aid():
    data = request.json
...
@mini_apps_bp.route('/immunity_booster', methods=['POST'])
...
@mini_apps_bp.route('/anti_inflammatory', methods=['POST'])
...
@mini_apps_bp.route('/antioxidant_rich', methods=['POST'])
...
@mini_apps_bp.route('/low_gi_option', methods=['POST'])
def low_gi_option():
    data = request.json
...
@mini_apps_bp.route('/high_protein_option', methods=['POST'])
...
@mini_apps_bp.route('/fiber_rich_option', methods=['POST'])
...
@mini_apps_bp.route('/seasonal_swap', methods=['POST'])
def seasonal_swap():
    data = request.json
...
@mini_apps_bp.route('/budget_swap', methods=['POST'])
def budget_swap():
    data = request.json
...
@mini_apps_bp.route('/leftover_idea', methods=['POST'])
def leftover_idea():
    data = request.json
...
@mini_apps_bp.route('/stress_relief', methods=['POST'])
def stress_relief():
    data = request.json
    context = data.get('context', 'general')
...
@mini_apps_bp.route('/focus_technique', methods=['POST'])
def focus_technique():
    data = request.json
...
@mini_apps_bp.route('/exercise_alternative', methods=['POST'])
