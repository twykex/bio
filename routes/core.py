...
@core_bp.route('/init_context', methods=['POST'])
def init_context():
...
@core_bp.route('/generate_week', methods=['POST'])
def generate_week():
    data = request.json
...
@core_bp.route('/chat_agent', methods=['POST'])
def chat_agent():
    data = request.json
    session = get_session(data.get('token'))
...
@core_bp.route('/get_recipe', methods=['POST'])
def get_recipe():
    data = request.json
    prompt = f"""
...
@core_bp.route('/generate_shopping_list', methods=['POST'])
...
@core_bp.route('/generate_workout', methods=['POST'])
...
@core_bp.route('/explain_biomarker', methods=['POST'])
